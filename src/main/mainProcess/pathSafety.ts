...
export const isExistingDirectory = (dirPath: PathLike) => {
  try {
...
export const resolveWithinDir = (baseDir: string, relPath: string) => {
...
export const safeModuleName = (moduleName: string) => {
...
export const safeJsonFilename = (filename: string) => {
